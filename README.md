...
[![Build Status](https://travis-ci.org/yaacov/tree-search-language/v4.svg?branch=master)](https://travis-ci.org/yaacov/tree-search-language/v4)
...
git clone git@github.com:yaacov/tree-search-language/v4.git
